...
class Inscripciones_2: 
    def __init__(self, master=None):
        ...
        self.tView.column("Estudiante",anchor="w",stretch=False,width=246)
        self.tView.column("Curso_descripcion",anchor="w",stretch=False,width=246)
        self.tView.column("tV_descripción",anchor="w",stretch=False,width=246)
        #Cabeceras
        ...
        self.scroll_H.place(anchor="s", height=12, width=1534, x=30, y=595)
        self.scroll_Y = ttk.Scrollbar(self.frm_1, name="scroll_y")
        self.scroll_Y.configure(orient="vertical")
        self.scroll_Y.place(anchor="s", height=250, width=15, x=750, y=300)
